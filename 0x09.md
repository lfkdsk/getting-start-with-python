...
到这里，我们对类的机制已经有了一个比较基本的了解，除了我们自己编写的类，我们还可以使用 **Python标准库** 里面的任何类以及函数。Python标准库是一组模块，安装的 Python 都带有标准库。Python 标准库功能非常广泛，为日常编程中出现的许多问题提供了标准化解决方案，如果我们能稍微花时间了解一下Python标准库里的常用模块的API，我们的编程能力和解决问题的能力都能获益。下面我们稍微介绍几个常用的模块的简单用法。
